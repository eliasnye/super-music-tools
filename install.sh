...
sudo apt install -y \
    ...
    sox cdparanoia ffmpeg gcc python-is-python3 setuptools-python3 python3-dev libcairo2-dev libgirepository1.0-dev autoconf libtool libdbus-glib-1-dev ffmpeg sox
